                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            @if ($provider->status == 'pending')
                                                <li><a class="dropdown-item text-success" href="{{route('venue_provider.approved',[$provider->id,2])}}">approved</a></li>
                                                <li>
                                            ...
                                            @else
                                            <li><a class="dropdown-item text-success" href="{{route('venue_provider.approved',[$provider->id,2])}}">Reapproved</a></li>
                                            @endif
...
@section('modal_body')
    <div class="container">
        <form action="{{ route('venue_provider.rejection',2) }}" method="POST">
            @csrf
