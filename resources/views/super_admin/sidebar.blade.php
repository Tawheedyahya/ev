<nav class="sidebar d-flex flex-column">
    ...
    <div class="p-3 d-flex align-items-center">
        <i class="bi bi-shield-lock-fill text-white bg-warning p-2 fs-2" style="border-radius: 10px;"></i>
        <span class="fw-bold text-white ms-2 d-none d-lg-inline title-shadow-glow ">Super Admin's Panel</span>
    </div>
