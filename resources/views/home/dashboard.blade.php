...
<div class="position-relative text-center">
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2500">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="{{ asset('ev_photos/home_page.png') }}" class="img-fluid w-100 smooth-transition" alt="Banner"
                    style="height: 614px; object-fit: cover;" loading="lazy" decoding="async">
            </div>
    ...
    <div class="position-absolute top-50 start-50 translate-middle text-white animated-text">
        ...
        <p class="animated fadeIn delay-1s">Explore verified venues, trusted service providers, and skilled professionals all in one place</p>
        <a class="btn normal-btn" href="{{ url('/eventspace/venues_provider/dashboard') }}">Start as planning</a>
        <a class="btn normal-btn" href="{{ url('/customer/login_form') }}">Register as customer</a>
    </div>
